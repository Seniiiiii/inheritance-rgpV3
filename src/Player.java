...
public class Player {
    ...
    protected ArrayList<Item> arrItem;
    ...
    public void pilihanAksi() {
        ...
        for (Item objItem:arrItem) {
            ...
            // karena di class Ruangan dan Player memiliki perintah yang sama pada method pilihanAksi
            // maka dibuat init objRuangan, agar method listDeskripsi dapat digunakan oleh kedua method pada class yang berbeda
            Ruangan objRuangan = new Ruangan(); // init objRuangan
            objRuangan.listDeskripsi(urutPil, subPil, arrPil); // ambil method list deskripsi di ruangan
        }
