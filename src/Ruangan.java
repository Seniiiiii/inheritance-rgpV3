...
public class Ruangan {
    ...
    public void listDeskripsi(int urutPil, int subPil, ArrayList<String> arrPil){ // method list deskripsi urutan menu, untuk digunakan di pilihan aksi Ruangan dan Player

        for (String strPil:arrPil) { // looping urutan menu
            subPil++;
...
//        nampilin arraylist item
        for (Item objItem:arrItem) {
            ...
            //print pilihan
            listDeskripsi(urutPil,subPil ,arrPil); // array List deskripsi  urutan menu penomoran dari method
        }
        ...
        listDeskripsi(urutPil,subPil ,objPintu.getAksi()); // array List deskripsi  urutan menu pintu dari method
        ...
        listDeskripsi(urutPil,subPil ,objNPC.getAksi()); // array List deskripsi  urutan menu npc dari method
